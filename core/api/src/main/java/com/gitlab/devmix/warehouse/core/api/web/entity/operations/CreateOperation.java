...
import com.gitlab.devmix.warehouse.core.api.web.entity.handlers.CreateHandler;
...
@Builder
@Value
public final class CreateOperation<E, R extends Request> implements Operation<E, R> {

    private final Class<E> entityClass;
    private final Class<R> parametersClass;
    private final CreateHandler<E, R> handler;
